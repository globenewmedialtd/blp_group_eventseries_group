...
namespace Drupal\blp_group_eventseries_group;
...
class SocialGroupFlexibleGroupConfigOverride implements ConfigFactoryOverrideInterface {
  ...
  public function loadOverrides($names) {
    ...
    $filter_node_access = [
      'id' => 'es_group_node_access',
      'table' => 'node_access',
      'field' => 'es_group_node_access',
      'relationship' => 'none',
      'group_type' => 'group',
      'admin_label' => '',
      'operator' => '=',
      ...
      'plugin_id' => 'es_group_node_access',
    ];
    ...
    foreach ($config_names as $config_name => $displays) {
      if (in_array($config_name, $names)) {
        ...
        foreach ($displays as $display) {
          $overrides[$config_name]['display'][$display]['display_options']['filters']['es_group_node_access'] = $filter_node_access;
        }
      }
    }
    ...
    foreach ($config_names as $config_name) {
      if (in_array($config_name, $names)) {
        $overrides[$config_name] = [
          'dependencies' => [
            'config' => [
              'es_group-group_membership' => 'group.content_type.es_group-group_membership',
            ],
          ],
          'display' => [
            'default' => [
              'display_options' => [
                'filters' => [
                  'type' => [
                    'value' => [
                      'es_group-group_membership' => 'es_group-group_membership',
                    ],
                  ],
                ],
              ],
    ...
    $config_names = [
      'views.view.group_events' => 'es_group-group_node-event',
      'views.view.group_topics' => 'es_group-group_node-topic',
    ];
    ...
    if (in_array($config_name, $names, FALSE)) {
      $overrides[$config_name]['third_party_settings']['activity_logger']['activity_bundle_entities'] =
        [
          'group_content-es_group-group_node-event' => 'group_content-es_group-group_node-event',
          'group_content-es_group-group_node-topic' => 'group_content-es_group-group_node-topic',
        ];
    }
    ...
    if (in_array($config_name, $names, FALSE)) {
      $overrides[$config_name]['third_party_settings']['activity_logger']['activity_bundle_entities'] =
        [
          'group_content-es_group-group_membership' => 'group_content-es_group-group_membership',
        ];
    }
    ...
    if (in_array($config_name, $names, FALSE)) {
      $overrides[$config_name]['third_party_settings']['activity_logger']['activity_bundle_entities'] =
        [
          'group_content-es_group-group_invitation' => 'group_content-es_group-group_invitation',
        ];
    }
