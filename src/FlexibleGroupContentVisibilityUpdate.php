 ...
 *
 * @package Drupal\blp_group_eventseries_group
 */
class FlexibleGroupContentVisibilityUpdate {
  ...
  public static function batchUpdateGroupContentVisibility(Group $group, array $changed_visibility, array $new_options) {
    ...
    for ($i = 0; $i < $num_operations; $i++) {
      $operations[] = [
        '\Drupal\blp_group_eventseries_group\FlexibleGroupContentVisibilityUpdate::updateVisibility',
        [
          $entities[$i],
          $new_options,
        ],
    ...
    $batch = [
      ...
      'finished' => '\Drupal\blp_group_eventseries_group\FlexibleGroupContentVisibilityUpdate::updateVisibilityFinishedCallback',
    ];
