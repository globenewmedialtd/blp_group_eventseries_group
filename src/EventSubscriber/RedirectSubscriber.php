...
namespace Drupal\blp_group_eventseries_group\EventSubscriber;
 ...
 *
 * @package Drupal\blp_group_eventseries_group\EventSubscriber
 */
class RedirectSubscriber implements EventSubscriberInterface {
  ...
  public function checkForRedirection(GetResponseEvent $event) {
    ...
    if (
      ...
      !blp_group_eventseries_group_can_join_directly($group)
    ) {
      $this->doRedirect($event, $group);
    }
    elseif (
      in_array($route_name, $routes) &&
      !blp_group_eventseries_group_community_enabled($group) &&
